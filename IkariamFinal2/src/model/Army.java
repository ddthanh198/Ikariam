...
// lưu số lượng quân đội và các chỉ tăng công, giáp của từng quân
public class Army {
    private static final String TAG = "class Army function ";
    ...
    public static enum Unit {
        Archer(2, ""), Balloon(1, ""), Catapult(2, ""),
        Gyrocopter(1, ""), Hoplite(1, ""), Mortar(1, ""),
        Ram(3, ""), Slinger(3, ""), Spearman(2, ""),
        SteamGiant(2, ""), Sulfur(1, ""), Swordsman(1, ""),
        Wall(0, "");
...
//        return army;
 //   }
    ...
    // tính toán thời gian di chuyển của quân đội
    public int getSpeedTimeForWholeRoute() {
        ...
        return (7*60 + 30)*1000; // chỉ có máy bay
    }
