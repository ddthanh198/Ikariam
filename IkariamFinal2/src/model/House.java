...
public class House {
    ...
    private Wall wall;
    private int typeOfHouse = 2; //0: của mình, 1: của đồng minh, 2: của địch
    private Army army;
    ...
    public void addArmyToBattleField(Army attackArmy, SendingArmy sendingArmy, int xSpeed) {
        long timeToTravel = (sendingArmy.getFinishTime() - sendingArmy.getStartTime());
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                long counter = 0;
                while(counter < timeToTravel){
                    try {
                        Thread.sleep(1000);
                        long timeX = BattleFieldFighting.xSpeed * 1000;
                        counter += timeX;
