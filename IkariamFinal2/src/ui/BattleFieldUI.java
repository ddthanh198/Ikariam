...
//                battleFieldFighting.setMyBattleField(battleField);
    ...
    private void saveArmyAndSentedArmy() {
      ...
      //  sendingArmy.add(temp);
        ...
        System.out.println("time to travel " +(temp.getFinishTime() - temp.getStartTime())/1000/60);
        
//        IsLandUI.currentHouse.addArmyToBattleField(temp.getArmy());
        IsLandUI.currentHouse.addArmyToBattleField(temp.getArmy(), temp, BattleFieldFighting.xSpeed);
    }
