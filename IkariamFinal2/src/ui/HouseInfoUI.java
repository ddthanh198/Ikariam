...
public class HouseInfoUI extends JDialog {
    ...
    JLabel lblLvHou, lblLvWall, lblTypeOfHou, lbNameHouse;
    ...
    public void addControls() {
        ...
        lbNameHouse = new JLabel("House's name");
        lbNameHouse.setBounds(50, 30, 120, 20);
        pnMain.add(lbNameHouse);
        
        txtNameHouse = new JTextField();
        txtNameHouse.setBounds(180, 30, 150, 20);
        txtNameHouse.setText(IsLandUI.currentHouse.getName());
        pnMain.add(txtNameHouse);
...
//            IsLandUI.currentHouse.getBattleField().resetAll(IsLandUI.currentHouse.getLevelOfHouse());
    ...
    private void setIconHouse(String type) {
        if (IsLandUI.currentHouse.getLevelOfHouse() == 1) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv1_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv1_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 2 && IsLandUI.currentHouse.getLevelOfHouse() <= 3) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv2_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv2_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 4 && IsLandUI.currentHouse.getLevelOfHouse() <= 6) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv4_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv4_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 7 && IsLandUI.currentHouse.getLevelOfHouse() <= 9) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv7_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv7_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 10 && IsLandUI.currentHouse.getLevelOfHouse() <= 12) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv10_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv10_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 13 && IsLandUI.currentHouse.getLevelOfHouse() <= 15) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv13_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv13_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() == 16 || IsLandUI.currentHouse.getLevelOfHouse() == 17) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv16_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv16_a.PNG")));
            }else if(type.equals("Enemy")){
        ...
        if (IsLandUI.currentHouse.getLevelOfHouse() >= 18) {
            if(type.equals("My House")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv18+_blue.PNG")));
            }else if(type.equals("My Ally")){
                IsLandUI.currentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/House/houseLv18+_a.PNG")));
            }else if(type.equals("Enemy")){
